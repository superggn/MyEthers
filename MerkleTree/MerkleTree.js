...
const merkleTreeJson = require("./MerkleTree.json");
...
// 2. 创建provider和wallet
// 准备 alchemy API 可以参考
//   https://github.com/AmazingAng/WTFSolidity/blob/main/Topics/Tools/TOOL04_Alchemy/readme.md
...
// const bytecodeNFT = contractJson.object;
const bytecodeNFT = merkleTreeJson.data.bytecode.object;
...
const main = async () => {
  ...
  if (ethers.formatEther(balanceETH) > 0.002) {
    ...
    console.log(
      "1. alchemy水龙头: https://www.alchemy.com/faucets/ethereum-sepolia/"
    );
